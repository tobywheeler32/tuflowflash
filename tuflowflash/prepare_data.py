...
class prepareData:
    ...
    def merge_bom_forecasts(self):
        ...
        bom_nowcast_da=bom_nowcast_da.assign_coords(time=(bom_nowcast_da["time"]/3600000000000.0).astype(float32)) #because it is read as nano seconds
        ...
        bom_forecast_da=bom_forecast_da.assign_coords(time=(time).astype(float32))
